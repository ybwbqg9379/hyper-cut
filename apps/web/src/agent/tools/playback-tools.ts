...
export const seekForwardTool: AgentTool = {
	name: "seek_forward",
	description:
		"向前跳转指定秒数（默认1秒）。Seek forward by specified seconds (default 1).",
	parameters: {
		type: "object",
		properties: {
			seconds: {
...
export const seekBackwardTool: AgentTool = {
	name: "seek_backward",
	description:
		"向后跳转指定秒数（默认1秒）。Seek backward by specified seconds (default 1).",
	parameters: {
		type: "object",
		properties: {
			seconds: {
...
export const jumpForwardTool: AgentTool = {
	name: "jump_forward",
	description:
		"向前跳转指定秒数（默认5秒）。Jump forward by specified seconds (default 5).",
	parameters: {
		type: "object",
		properties: {
			seconds: {
...
export const jumpBackwardTool: AgentTool = {
	name: "jump_backward",
	description:
		"向后跳转指定秒数（默认5秒）。Jump backward by specified seconds (default 5).",
	parameters: {
		type: "object",
		properties: {
			seconds: {
	...
	execute: async (): Promise<ToolResult> => {
		try {
			...
			return {
				success: true,
				message: muted
					? "已静音播放 (Playback muted)"
					: "已取消静音 (Playback unmuted)",
