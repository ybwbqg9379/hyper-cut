...
export const copySelectedTool: AgentTool = {
	name: "copy_selected",
	description:
		"复制当前选中的片段到剪贴板。Copy the selected element(s) to clipboard.",
	parameters: {
		type: "object",
		properties: {},
		required: [],
...
export const pasteCopiedTool: AgentTool = {
	name: "paste_copied",
	description:
		"在播放头位置粘贴已复制的片段。Paste copied element(s) at the current playhead position.",
	parameters: {
		type: "object",
		properties: {},
		required: [],
...
export const pasteAtTimeTool: AgentTool = {
	name: "paste_at_time",
	description:
		"在指定时间粘贴已复制的片段。Paste copied element(s) at a specific time.",
	parameters: {
		type: "object",
		properties: {
			time: {
...
export const toggleMuteSelectedTool: AgentTool = {
	...
	description:
		"切换选中片段的静音状态。Toggle mute/unmute for selected element(s).",
	parameters: {
		type: "object",
		properties: {},
		required: [],
...
export const toggleVisibilitySelectedTool: AgentTool = {
	...
	description:
		"切换选中片段的可见性。Toggle show/hide for selected element(s).",
	parameters: {
		type: "object",
		properties: {},
		required: [],
