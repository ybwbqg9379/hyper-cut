...
export const metadata: Metadata = {
	title: "Blog - HyperCut",
	description:
		"Read the latest news and updates about HyperCut, the free and open-source video editor.",
	openGraph: {
		title: "Blog - HyperCut",
		description:
			"Read the latest news and updates about HyperCut, the free and open-source video editor.",
...
export default async function BlogPage() {
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about HyperCut, the free and open-source video editor."
		>
