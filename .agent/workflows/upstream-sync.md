...
| 2026-03-24 | `f2eed05` | 1 | Blog CMS build fix (Marble CMS env vars in Dockerfile/docker-compose). 2 modify/delete conflicts on blog files resolved by deletion (intentionally removed). No source code changes. |
